(function () {
    ...
    angular
        .module('app.login')
        .controller('LoginPasswordResetController', LoginPasswordResetController);
    LoginPasswordResetController.$inject = ['authservice', '$location', 'logger', '$state', 'dataservice', 'menuservice', 'ngDialog'];
    function LoginPasswordResetController(authservice, $location, logger, $state, dataservice, menuservice, ngDialog) {
