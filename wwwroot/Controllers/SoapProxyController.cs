...
{
    public class SoapProxyController : BaseApiController
    {
        public IHttpActionResult Proxy(String soapServerUrl, String soapServicePath, String soapServiceUsername, String soapServicePassword, String soapAction)
        {
            return Ok();
//<?php
